    ...
    <div class="container-fluid">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">{{ trans('labels.companies.add-new-company') }}</h3>
            </div>
             {{ Form::open(['route' => 'companies.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-companies', 'files' => true]) }}
                           <div class="card-body">
